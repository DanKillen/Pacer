...
{
    public TimeSpan CalculateEquivalentMarathonTime(TimeSpan raceTime, RaceType raceType)
    {
        ...
        {
            case RaceType.FiveK:
                targetTimes = fiveKTimes;
                break;
            case RaceType.TenK:
                targetTimes = tenKTimes;
                break;
            case RaceType.HalfMarathon:
                targetTimes = halfMarathonTimes;
                break;
            default:
                throw new ArgumentException($"Unsupported race type: {raceType}");
        }

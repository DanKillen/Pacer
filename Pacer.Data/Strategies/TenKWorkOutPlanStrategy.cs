...
namespace Pacer.Data.Strategies
{
    public class TenKWorkoutPlanStrategy : BaseWorkoutPlanStrategy
    {
        ...
        public TenKWorkoutPlanStrategy(RunningProfile runningProfile, DateTime raceDate, TimeSpan targetTime, IWorkoutPaceCalculator workoutPaceCalculator)
            : base(runningProfile, raceDate, targetTime, workoutPaceCalculator)
        {
            InitializePaces(RaceType.TenK);
        }

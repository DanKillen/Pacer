...
namespace Pacer.Data.Strategies
{
    public class AdvancedMarathonWorkoutPlanStrategy : BaseWorkoutPlanStrategy
    {
        ...
        public AdvancedMarathonWorkoutPlanStrategy(IRunningProfileService runningProfileService, IWorkoutPaceCalculator workoutPaceCalculator, DateTime raceDate, TimeSpan targetTime)

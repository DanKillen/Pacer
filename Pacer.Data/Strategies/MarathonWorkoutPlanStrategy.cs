...
namespace Pacer.Data.Strategies
{
    public class MarathonWorkoutPlanStrategy : BaseWorkoutPlanStrategy
    {
        ...
        public MarathonWorkoutPlanStrategy(RunningProfile runningProfile, DateTime startDate, DateTime endDate, TimeSpan targetTime)
            : base(runningProfile, startDate, endDate, targetTime, RaceType.Marathon)
        {
        }

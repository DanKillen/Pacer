...
namespace Pacer.Data.Strategies
{
    ...
    {
        public TenKWorkoutPlanStrategy(RunningProfile runningProfile, DateTime startDate, DateTime endDate, TimeSpan targetTime)
         : base(runningProfile, startDate, endDate, targetTime, RaceType.TenK)
        {
        }

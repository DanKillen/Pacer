...
namespace Pacer.Data.Strategies
{
    ...
    {
        public FiveKWorkoutPlanStrategy(RunningProfile runningProfile, DateTime startDate, DateTime endDate, TimeSpan targetTime)
         : base(runningProfile, startDate, endDate, targetTime, RaceType.FiveK)
        {            
        }
